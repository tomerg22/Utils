...
(() => {
  ...
  // explicitly instead of returning a plausible-looking empty result.
  const blocked = /Captcha Interception/i.test(document.title || '') ||
    /_____tmd_____|\/punish/.test(location.href);
